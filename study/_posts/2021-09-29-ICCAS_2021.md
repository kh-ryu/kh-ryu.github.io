...
![Vertical Error](/assets/images/ver.jpg){: width="40%" height="50%"} ![Horizontal Error](/assets/images/Hor.jpg){: width="40%" height="50%"}
![Position Error](/assets/images/Pos.jpg){: width="40%" height="50%"} ![Attitude Error](/assets/images/att.jpg){: width="40%" height="50%"}
*Error Plot*