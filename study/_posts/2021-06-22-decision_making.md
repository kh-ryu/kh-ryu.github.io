...
This is term project form "Decision making for Autonomous Aerospace Systems". The class covered various topics for unmanned vehicle platforms. For path planning, potential field, graph search, and sampling-based algorithms are introduced. In control part, we learned controllability of non-holonomic systems and various control methods, such as sliding mode control, adaptive control, back stepping contral and model predictive control. Finally, graph network of multi-agent systems and basic game theory like nash equilibrium are given.
